...
export const BLOCKED_EXT = new Set([
  ...
  "js", "jse", "ws", "wsf", "wsh", "jar", "apk", "app", "dmg", "pkg", "deb", "rpm",
  "sh", "bash", "run", "dll", "sys", "drv", "reg", "inf", "cpl", "msc", "hta",
  "lnk", "iso", "img", "bin", "php", "asp", "aspx", "cgi",
]);
...
export function validateBookFile(file: File): { ok: true } | { ok: false; message: string } {
