...
export default function HeroColegio() {
  return (
    <section className="relative flex min-h-[88vh] flex-col items-center justify-center overflow-hidden px-4 text-center">
      ...
      >
        <Link to="/feed" className="neo-btn rounded-xl bg-primary px-7 py-3 font-bold text-primary-foreground glow-bloom">
          {colegio.cta.boton}
        </Link>
        <Link to="/biblioteca" className="neo-btn rounded-xl bg-card px-7 py-3 font-bold">
          Biblioteca digital
        </Link>
      </motion.div>
