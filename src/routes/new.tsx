...
function NewPostPage() {
  ...
  const [stage, setStage] = useState<"idle" | "moderating" | "publishing">(
    "idle",
  );
      ...
      <div>
        ...
        <div className="mx-auto max-w-2xl px-4 py-16 text-center">
          <div className="neo-card p-8">
            <h1 className="font-display text-3xl font-extrabold text-destructive">
              Cuenta suspendida
            </h1>
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <p className="text-muted-foreground">
          <ShieldCheck className="mr-1 inline h-4 w-4" /> Antes de publicar, la
          IA revisa que el contenido sea apto para la comunidad escolar.
        </p>
        ...
        <form onSubmit={submit} className="neo-card mt-6 space-y-5 p-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              La IA analizará esta imagen antes de publicar.
            </p>
          </div>
          <div>
