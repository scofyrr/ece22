import { r as l, s as o, j as e, L as x } from "./index-C-CdgMgA.js";
import { N as p, T as h } from "./Navbar-BTC3bKq4.js";
import { c as d } from "./createLucideIcon-Eusou0P7.js";
...
function w() {
  ...
  l.useEffect(() => {
    (async () => {
      const { data: s, error: a } = await o
        .from("profiles")
        .select("dni, full_name, grade, points, max_points, level")
        .gt("max_points", 0)
        .order("max_points", { ascending: !1 })
        .limit(50);
      if (a) {
        const m = await o
          .from("profiles")
          ...
          .limit(50);
        n((m.data ?? []).map((i) => ({ ...i, max_points: i.points })));
        return;
      }
      n(s ?? []);
    })();
  ...
  const c = (s) =>
    s === 0
      ? e.jsx(u, { className: "h-5 w-5 text-lemon" })
      : s === 1
        ? e.jsx(r, { className: "h-5 w-5" })
        : s === 2
          ? e.jsx(r, { className: "h-5 w-5 text-coral" })
          : e.jsxs("span", {
              ...
              t.map((s, a) =>
                e.jsxs(
                  x,
                  {
                    to: "/profile/$dni",
                    params: { dni: s.dni },
                    className: `flex items-center gap-4 px-4 py-3 hover:bg-muted ${a < 3 ? "bg-card" : ""}`,
                    children: [
                      e.jsx("div", {
                      ...
                      e.jsx("span", {
                        ...
                        title: `Actual: ${s.points} pts`,
                        children: s.max_points ?? s.points,
                      }),
                    ],
                  },
                  s.dni,
