import { j as e, L as c, r, s as i } from "./index-C-CdgMgA.js";
import { N as b } from "./Navbar-BTC3bKq4.js";
import { P as j } from "./PostCard-8jU_9RG_.js";
import { S as v } from "./sparkles-CP5ZMhoC.js";
import { c as y } from "./createLucideIcon-Eusou0P7.js";
                ...
                c,
                {
                  ...
                  children: [
                    e.jsx("div", {
                      ...
                      style: {
                        backgroundImage: t.cover_image_url
                      ...
                      children: [
                        ...
                        t.author &&
                          e.jsxs("p", {
                            ...
                            children: ["por ", t.author.full_name],
                          }),
                      ],
                    }),
                  ],
      ...
      children: [
        ...
        e.jsxs("main", {
          ...
          children: [
            ...
            d.length > 0 && e.jsx(k, { items: d }),
            e.jsxs("div", {
              className: "mb-6 flex flex-wrap items-center gap-2",
              children: [
                e.jsxs("span", {
                  className: "inline-flex items-center gap-1 text-sm font-bold",
                  children: [e.jsx(_, { className: "h-4 w-4" }), " Filtrar:"],
                }),
                e.jsx("button", {
                  onClick: () => m(null),
                  className: `chip ${l ? "bg-card" : "bg-primary text-primary-foreground"}`,
                  children: "Todas",
                }),
                p.map((a) =>
                  e.jsxs(
                    ...
                    {
                      onClick: () => m(a.id),
                      className: `chip ${l === a.id ? "bg-primary text-primary-foreground" : "bg-card"}`,
            ...
            f
              ...
              : o.length === 0
                ...
                : e.jsx("div", {
                    className: "grid gap-6 md:grid-cols-2",
                    children: o.map((a) => e.jsx(j, { post: a }, a.id)),
                  }),
          ],
        }),
      ],
